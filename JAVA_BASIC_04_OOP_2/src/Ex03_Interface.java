...
추상 클래스 와 인터페이스 차이점
1. 추상클래스 (완성 + 미완성) , 인터페이스(모든 것이 미완성) 
...
인터페이스 implements
 ...
 추상클래스 인터페이스 다른점
 3. 추상클래스 (완성된 코드 일부) 그러나 인터페이스는 전제 미완성 코드(상수 _default
 3.1 원칙적으로는 클래스는 다중상속 <<계층적 상속 또는 포함 관계>.. */
	//그러나 일반적으론는

/*
설계 최상위 단계 ....인터페이스 : 약속 , 규칙 , 규약 , 표준 을 만드는 것  
초급개발자 : 인터페이스 사용 방법 ....
구현부가 없어요 (추상자원)
